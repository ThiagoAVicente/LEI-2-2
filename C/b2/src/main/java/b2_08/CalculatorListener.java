...
public interface CalculatorListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CalculatorParser#assi}.
	 * @param ctx the parse tree
	 */
	void enterAssi(CalculatorParser.AssiContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculatorParser#assi}.
	 * @param ctx the parse tree
	 */
	void exitAssi(CalculatorParser.AssiContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterExprParentesis(CalculatorParser.ExprParentesisContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ExprParentesis}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitExprParentesis(CalculatorParser.ExprParentesisContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ExprSigned}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterExprSigned(CalculatorParser.ExprSignedContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ExprSigned}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitExprSigned(CalculatorParser.ExprSignedContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterExprVarName(CalculatorParser.ExprVarNameContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ExprVarName}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitExprVarName(CalculatorParser.ExprVarNameContext ctx);
	/**
