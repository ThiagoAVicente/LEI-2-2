...
public class SuffixCalculatorBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements SuffixCalculatorVisitor<T> {
	 ...
	 */
	@Override
	public T visitProgram(SuffixCalculatorParser.ProgramContext ctx) {
	 ...
	 */
	@Override
	public T visitStat(SuffixCalculatorParser.StatContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public T visitExpr(SuffixCalculatorParser.ExprContext ctx) {
		return visitChildren(ctx);
	}
}