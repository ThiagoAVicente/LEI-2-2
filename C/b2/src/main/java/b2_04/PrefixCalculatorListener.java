...
public interface PrefixCalculatorListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PrefixCalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterExpr(PrefixCalculatorParser.ExprContext ctx);
	/**
	 * Exit a parse tree produced by {@link PrefixCalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitExpr(PrefixCalculatorParser.ExprContext ctx);
}